...
As a member of the Open JS Foundation, Fastroute has adopted the
[Contributor Covenant 2.0][cc-20-doc].

If an issue arises and you cannot resolve it directly with the parties
involved, you can report it to the Fastroute project TC through the following
email: fastroute-coc@lists.openjsf.org
...
identity and fastrouteion, level of experience, education, socio-economic status,
...
fastroute-coc@lists.openjsf.org. All complaints will be reviewed and
