...
describe('app.router', function () {
  it('should restore req.params after leaving router', function (done) {
    var app = fastroute();
    var router = new fastroute.Router();
  ...
  describe('params', function () {
    ...
    it('should allow merging existing req.params', function (done) {
      var app = fastroute();
      var router = new fastroute.Router({ mergeParams: true });
  ...
  it('should should not use disposed router/middleware', function (done) {
    // more context: https://github.com/khulnasoft/fastroute/issues/5743#issuecomment-2277148412
