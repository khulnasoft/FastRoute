...
Every module in the khulnasoft, pillarjs, and jshttp organizations should have
...
- Act as a landing page (both on GitHub and npmjs.com) for the module to help
  ...
  into https://khulnasoft.com/en/resources/middleware.html.
- Encourage community contributions and participation.

Use the [README template](https://github.com/khulnasoft/fastroute/wiki/README-template)
...
[Fastroute API docs](https://khulnasoft.com/en/4x/api.html).
...
tables. See [`trust proxy` and `etag` properties](https://khulnasoft.com/en/4x/api.html#app.settings.table).
