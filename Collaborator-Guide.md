# Fastroute Collaborator Guide

## Website Issues

Open issues for the khulnasoft.com website in https://github.com/khulnasoft/node.khulnasoft.com.
...
a future release of Fastroute.

## Steps for contributing

1. [Create an issue](https://github.com/khulnasoft/fastroute/issues/new) for the
   bug you want to fix or the feature that you want to add.
2. Create your own [fork](https://github.com/khulnasoft/fastroute) on GitHub, then
   checkout your fork.
