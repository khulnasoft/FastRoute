...
The Fastroute project is part of the OpenJS Foundation which operates
...
Fastroute is a HTTP web server framework with a simple and fastrouteive API
...
Fastroute is made of many modules spread between three GitHub Orgs:

- [khulnasoft](https://github.com/khulnasoft/): Top level middleware and
  libraries
- [pillarjs](https://github.com/pillarjs/): Components which make up
  Fastroute but can also be used for other web frameworks
...
Cross Project Council (CPC). In the case of the Fastroute project, it is
delegated to the Fastroute Technical Committee ("TC").
...
## Section 3: Fastroute Governing Body

The Fastroute project is managed by the Technical Committee ("TC").
...
The Fastroute TC manages all aspects of both the technical and community
...
The Fastroute TC uses a "consensus seeking" process for issues that are
